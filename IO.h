...
#define IO_P8_7       P8_OUT_P7
#define IO_P8_8       P8_OUT_P8
#define IO_P8_9       P8_OUT_P9
#define IO_P8_10       P8_OUT_P10
#define IO_P8_11       P8_OUT_P11
#define IO_P8_12       P8_OUT_P12
#define IO_P8_13       P8_OUT_P13
...
#define INIO_P8_7       P8_IN_P7
#define INIO_P8_8       P8_IN_P8
#define INIO_P8_9       P8_IN_P9
#define INIO_P8_10       P8_IN_P10
#define INIO_P8_11       P8_IN_P11
#define INIO_P8_12       P8_IN_P12
#define INIO_P8_13       P8_IN_P13

#define SETIO_P8_0       P8_OMR = 0x00000001
#define SETIO_P8_1       P8_OMR = 0x00000002
#define SETIO_P8_2       P8_OMR = 0x00000004
#define SETIO_P8_3       P8_OMR = 0x00000008
#define SETIO_P8_4       P8_OMR = 0x00000010
#define SETIO_P8_5       P8_OMR = 0x00000020
#define SETIO_P8_6       P8_OMR = 0x00000040
#define SETIO_P8_7       P8_OMR = 0x00000080
#define SETIO_P8_8       P8_OMR = 0x00000100
#define SETIO_P8_9       P8_OMR = 0x00000200
#define SETIO_P8_10       P8_OMR = 0x00000400
#define SETIO_P8_11       P8_OMR = 0x00000800
#define SETIO_P8_12       P8_OMR = 0x00001000
#define SETIO_P8_13       P8_OMR = 0x00002000

#define RESETIO_P8_0       P8_OMR = 0x00010000
#define RESETIO_P8_1       P8_OMR = 0x00020000
#define RESETIO_P8_2       P8_OMR = 0x00040000
#define RESETIO_P8_3       P8_OMR = 0x00080000
#define RESETIO_P8_4       P8_OMR = 0x00100000
#define RESETIO_P8_5       P8_OMR = 0x00200000
#define RESETIO_P8_6       P8_OMR = 0x00400000
#define RESETIO_P8_7       P8_OMR = 0x00800000
#define RESETIO_P8_8       P8_OMR = 0x01000000
#define RESETIO_P8_9       P8_OMR = 0x02000000
#define RESETIO_P8_10       P8_OMR = 0x04000000
#define RESETIO_P8_11       P8_OMR = 0x08000000
#define RESETIO_P8_12       P8_OMR = 0x10000000
#define RESETIO_P8_13       P8_OMR = 0x20000000

#define TOGGLEIO_P8_0       P8_OMR = 0x00010001
#define TOGGLEIO_P8_1       P8_OMR = 0x00020002
#define TOGGLEIO_P8_2       P8_OMR = 0x00040004
#define TOGGLEIO_P8_3       P8_OMR = 0x00080008
#define TOGGLEIO_P8_4       P8_OMR = 0x00100010
#define TOGGLEIO_P8_5       P8_OMR = 0x00200020
#define TOGGLEIO_P8_6       P8_OMR = 0x00400040
#define TOGGLEIO_P8_7       P8_OMR = 0x00800080
#define TOGGLEIO_P8_8       P8_OMR = 0x01000100
#define TOGGLEIO_P8_9       P8_OMR = 0x02000200
#define TOGGLEIO_P8_10       P8_OMR = 0x04000400
#define TOGGLEIO_P8_11       P8_OMR = 0x08000800
#define TOGGLEIO_P8_12       P8_OMR = 0x10001000
#define TOGGLEIO_P8_13       P8_OMR = 0x20002000

#define CONTROLIO_P8_0(Mode)       P8_IOCR0 = (P8_IOCR0 & ~0x000000F0) | (Mode << 4)
#define CONTROLIO_P8_1(Mode)       P8_IOCR0 = (P8_IOCR0 & ~0x0000F000) | (Mode << 12)
#define CONTROLIO_P8_2(Mode)       P8_IOCR0 = (P8_IOCR0 & ~0x00F00000) | (Mode << 20)
#define CONTROLIO_P8_3(Mode)       P8_IOCR0 = (P8_IOCR0 & ~0xF0000000) | (Mode << 28)
#define CONTROLIO_P8_4(Mode)       P8_IOCR4 = (P8_IOCR4 & ~0x000000F0) | (Mode << 4)
#define CONTROLIO_P8_5(Mode)       P8_IOCR4 = (P8_IOCR4 & ~0x0000F000) | (Mode << 12)
#define CONTROLIO_P8_6(Mode)       P8_IOCR4 = (P8_IOCR4 & ~0x00F00000) | (Mode << 20)
#define CONTROLIO_P8_7(Mode)       P8_IOCR4 = (P8_IOCR4 & ~0xF0000000) | (Mode << 28)
#define CONTROLIO_P8_8(Mode)       P8_IOCR8 = (P8_IOCR8 & ~0x000000F0) | (Mode << 4)
#define CONTROLIO_P8_9(Mode)       P8_IOCR8 = (P8_IOCR8 & ~0x0000F000) | (Mode << 12)
#define CONTROLIO_P8_10(Mode)       P8_IOCR8 = (P8_IOCR8 & ~0x00F00000) | (Mode << 20)
#define CONTROLIO_P8_11(Mode)       P8_IOCR8 = (P8_IOCR8 & ~0xF0000000) | (Mode << 28)
#define CONTROLIO_P8_12(Mode)       P8_IOCR12 = (P8_IOCR12 & ~0x000000F0) | (Mode << 4)
#define CONTROLIO_P8_13(Mode)       P8_IOCR12 = (P8_IOCR12 & ~0x0000F000) | (Mode << 12)
...
#define INIO_P9_8       P9_IN_P8

#define SETIO_P9_2       P9_OMR = 0x00000004
#define SETIO_P9_3       P9_OMR = 0x00000008
#define SETIO_P9_4       P9_OMR = 0x00000010
#define SETIO_P9_5       P9_OMR = 0x00000020
#define SETIO_P9_6       P9_OMR = 0x00000040
#define SETIO_P9_7       P9_OMR = 0x00000080
#define SETIO_P9_8       P9_OMR = 0x00000100

#define RESETIO_P9_2       P9_OMR = 0x00040000
#define RESETIO_P9_3       P9_OMR = 0x00080000
#define RESETIO_P9_4       P9_OMR = 0x00100000
#define RESETIO_P9_5       P9_OMR = 0x00200000
#define RESETIO_P9_6       P9_OMR = 0x00400000
#define RESETIO_P9_7       P9_OMR = 0x00800000
#define RESETIO_P9_8       P9_OMR = 0x01000000

#define TOGGLEIO_P9_2       P9_OMR = 0x00040004
#define TOGGLEIO_P9_3       P9_OMR = 0x00080008
#define TOGGLEIO_P9_4       P9_OMR = 0x00100010
#define TOGGLEIO_P9_5       P9_OMR = 0x00200020
#define TOGGLEIO_P9_6       P9_OMR = 0x00400040
#define TOGGLEIO_P9_7       P9_OMR = 0x00800080
#define TOGGLEIO_P9_8       P9_OMR = 0x01000100

#define CONTROLIO_P9_2(Mode)       P9_IOCR0 = (P9_IOCR0 & ~0x00F00000) | (Mode << 20)
#define CONTROLIO_P9_3(Mode)       P9_IOCR0 = (P9_IOCR0 & ~0xF0000000) | (Mode << 28)
#define CONTROLIO_P9_4(Mode)       P9_IOCR4 = (P9_IOCR4 & ~0x000000F0) | (Mode << 4)
#define CONTROLIO_P9_5(Mode)       P9_IOCR4 = (P9_IOCR4 & ~0x0000F000) | (Mode << 12)
#define CONTROLIO_P9_6(Mode)       P9_IOCR4 = (P9_IOCR4 & ~0x00F00000) | (Mode << 20)
#define CONTROLIO_P9_7(Mode)       P9_IOCR4 = (P9_IOCR4 & ~0xF0000000) | (Mode << 28)
#define CONTROLIO_P9_8(Mode)       P9_IOCR8 = (P9_IOCR8 & ~0x000000F0) | (Mode << 4)
...
#define SETIO_P10_0       P10_OMR = 0x00000001
#define SETIO_P10_1       P10_OMR = 0x00000002
#define SETIO_P10_2       P10_OMR = 0x00000004
#define SETIO_P10_3       P10_OMR = 0x00000008

#define RESETIO_P10_0       P10_OMR = 0x00010000
#define RESETIO_P10_1       P10_OMR = 0x00020000
#define RESETIO_P10_2       P10_OMR = 0x00040000
#define RESETIO_P10_3       P10_OMR = 0x00080000

#define TOGGLEIO_P10_0       P10_OMR = 0x00010001
#define TOGGLEIO_P10_1       P10_OMR = 0x00020002
#define TOGGLEIO_P10_2       P10_OMR = 0x00040004
#define TOGGLEIO_P10_3       P10_OMR = 0x00080008

#define CONTROLIO_P10_0(Mode)       P10_IOCR0 = (P10_IOCR0 & ~0x000000F0) | (Mode << 4)
#define CONTROLIO_P10_1(Mode)       P10_IOCR0 = (P10_IOCR0 & ~0x0000F000) | (Mode << 12)
#define CONTROLIO_P10_2(Mode)       P10_IOCR0 = (P10_IOCR0 & ~0x00F00000) | (Mode << 20)
#define CONTROLIO_P10_3(Mode)       P10_IOCR0 = (P10_IOCR0 & ~0xF0000000) | (Mode << 28)
...
#define INIO_P11_6       P11_IN_P6
#define INIO_P11_7       P11_IN_P7
#define INIO_P11_8       P11_IN_P8
#define INIO_P11_9       P11_IN_P9
#define INIO_P11_10       P11_IN_P10
#define INIO_P11_11       P11_IN_P11
#define INIO_P11_12       P11_IN_P12
#define INIO_P11_13       P11_IN_P13
#define INIO_P11_14       P11_IN_P14
#define INIO_P11_15       P11_IN_P15




#define CONTROLIO_P11_0(Mode)       P11_IOCR0 = (P11_IOCR0 & ~0x000000F0) | (Mode << 4)
#define CONTROLIO_P11_1(Mode)       P11_IOCR0 = (P11_IOCR0 & ~0x0000F000) | (Mode << 12)
#define CONTROLIO_P11_2(Mode)       P11_IOCR0 = (P11_IOCR0 & ~0x00F00000) | (Mode << 20)
#define CONTROLIO_P11_3(Mode)       P11_IOCR0 = (P11_IOCR0 & ~0xF0000000) | (Mode << 28)
#define CONTROLIO_P11_4(Mode)       P11_IOCR4 = (P11_IOCR4 & ~0x000000F0) | (Mode << 4)
#define CONTROLIO_P11_5(Mode)       P11_IOCR4 = (P11_IOCR4 & ~0x0000F000) | (Mode << 12)
#define CONTROLIO_P11_6(Mode)       P11_IOCR4 = (P11_IOCR4 & ~0x00F00000) | (Mode << 20)
#define CONTROLIO_P11_7(Mode)       P11_IOCR4 = (P11_IOCR4 & ~0xF0000000) | (Mode << 28)
#define CONTROLIO_P11_8(Mode)       P11_IOCR8 = (P11_IOCR8 & ~0x000000F0) | (Mode << 4)
#define CONTROLIO_P11_9(Mode)       P11_IOCR8 = (P11_IOCR8 & ~0x0000F000) | (Mode << 12)
#define CONTROLIO_P11_10(Mode)       P11_IOCR8 = (P11_IOCR8 & ~0x00F00000) | (Mode << 20)
#define CONTROLIO_P11_11(Mode)       P11_IOCR8 = (P11_IOCR8 & ~0xF0000000) | (Mode << 28)
#define CONTROLIO_P11_12(Mode)       P11_IOCR12 = (P11_IOCR12 & ~0x000000F0) | (Mode << 4)
#define CONTROLIO_P11_13(Mode)       P11_IOCR12 = (P11_IOCR12 & ~0x0000F000) | (Mode << 12)
#define CONTROLIO_P11_14(Mode)       P11_IOCR12 = (P11_IOCR12 & ~0x00F00000) | (Mode << 20)
#define CONTROLIO_P11_15(Mode)       P11_IOCR12 = (P11_IOCR12 & ~0xF0000000) | (Mode << 28)
